...
import { detectRecurringTransactions, extractDayOfMonth } from "./features/ai/services/aiRecurring";
import {
  CATEGORY_ALERT_COUNT_KEY,
  FIRST_NAME_KEY,
  getStorage,
} from "./features/common/services/storage";
import {
  getCurrentSession,
...
import NextMonthPromptModal from "./features/common/components/NextMonthPromptModal";
...
import AddIncomeModal from "./features/budget/components/AddIncomeModal";
import SkeletonDashboard from "./features/dashboard/components/SkeletonDashboard";
import NamePromptModal from "./features/common/components/NamePromptModal";
import SettingsModal from "./features/common/components/SettingsModal";
import WeeklySummaryModal from "./features/ai/components/WeeklySummaryModal";
...
import ToolsMortgage from "./features/tools/pages/ToolsMortgage";
import ToolsRetirement from "./features/tools/pages/ToolsRetirement";
import ToolsDebt from "./features/debt/pages/ToolsDebt";
import ToolsEmergency from "./features/tools/pages/ToolsEmergency";
import {
  generateAndSaveSummary,
  getTodaysSummary,
  isSunday,
} from "./features/ai/services/weeklySummary";
