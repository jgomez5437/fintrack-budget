                ...
                {editingId === category.id ? (
                  <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                    <input
                      ...
                      onKeyDown={(event) =>
                        event.key === "Enter" && onSaveEdit(category.id)
                      }
                      ...
                      >
                        ...
                        >
                          ...
                          <div style={{ display: "flex", gap: "8px" }}>
                            ...
                            >
                              <span
                                style={{ color: C.textLight, fontWeight: 600 }}
                              >
                                $
                              </span>
                              <input
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <div style={{ position: "relative" }}>
                <input
                  ...
                  onKeyDown={(event) =>
                    event.key === "Enter" && onSubmitQuickAdd()
                  }
                  style={inputStyle}
                />
                  ...
                  >
                    {quickAutocomplete.map((name) => (
                      <div
                        key={name}
                        className="ac-item"
                        onClick={() => onPickQuickSuggestion(name)}
                        style={{
                          padding: "11px 16px",
                          fontSize: "14px",
                          color: C.textMid,
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                ...
                <select
                  value={quickTx.categoryId}
                  onChange={(event) => onQuickCategoryChange(event.target.value)}
